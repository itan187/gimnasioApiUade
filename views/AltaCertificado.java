	...
	private void initGui () {
		...
		try {
			...
			}
			{
				...
				fieldFechaEntrega = new JFormattedTextField(dateFormat);
				...
				aceptar.addActionListener(new ActionListener()
				{
					public void actionPerformed(ActionEvent evt) 
					{
						if (fieldNroCerti.getText().equals("") || fieldDocumento.getText().equals("") || fieldNombreMedico.getText().equals("") || jLabelFechaEntrega.getText().equals("") || fieldObs.getText().equals("")) {
							...
							Date df;
							try {
								df = new SimpleDateFormat("yyyy-MM-dd").parse(fieldFechaEntrega.getText());
								sistema.altaCertificado(
										Integer.parseInt(fieldNroCerti.getText()), 
										Integer.parseInt(fieldDocumento.getText()),
										df, 
										fieldNombreMedico.getText(), 
										fieldObs.getText()
									);
