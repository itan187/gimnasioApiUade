...
public class EmpleadoAdminAlta extends javax.swing.JFrame {
	...
	public EmpleadoAdminAlta (RrhhController s) {
		super();
		sistema = s;
		initGui();
	}
				...
				buttonAceptar.addActionListener(new ActionListener()
				{
					public void actionPerformed(ActionEvent evt) 
					{
						if (fieldNombre.getText().equals("") || fieldDocumento.getText().equals("") || fieldMail.getText().equals("") || fieldTelefono.getText().equals("") || fieldDomicilio.getText().equals("") || fieldEscalaSalarial.getText().equals("") || fieldSueldo.getText().equals("")) {
							String mensajeError = "¡Atención! Faltan completar campos y por ello no se puede agregar el empleado administrativo.";
						    JOptionPane.showMessageDialog(null, mensajeError);
						} else {
							sistema.altaEmpleadoAdmin(
									fieldNombre.getText(), 
